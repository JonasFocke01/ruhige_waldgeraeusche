...
describe('Text', () => {
    ...
    it('has expected size', async () => {
        ...
        await waitFor(() => {
            expect(getByText('Testing').getAttribute('class')).toContain('text-4xl');
        }, { timeout: 1000 });
    ...
    it('working effects', async () => {
        ...
        await waitFor(() => {
            expect(getByText('This').getAttribute('class')).toContain('line-through');
        ...
        await waitFor(() => {
            ...
            expect(getByText('This').getAttribute('class')).not.toContain('line-through');
            expect(getByText('is').getAttribute('class')).not.toContain('font-bold');
