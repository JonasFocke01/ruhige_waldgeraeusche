...
describe('Table', () => {
    it('implements all it needs to be a basic table', async () => {
        const { getAllByText, getByPlaceholderText, getByText, container } = render(Table, {
            props: {
                explainColumns: [
        ...
        await fireEvent.click(getByText('Testheadlinenormal'), new MouseEvent('click'));
        await waitFor(() => {
        ...
        expect(getByPlaceholderText('Filter').value).toBe('item2');
        await waitFor(() => {
