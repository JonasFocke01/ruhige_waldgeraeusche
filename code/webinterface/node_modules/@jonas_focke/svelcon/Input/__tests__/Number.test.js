...
describe('Number', () => {
    it('rendered propperly', async () => {
        ...
        expect(getByPlaceholderText('Testplaceholder'));
        expect(getByPlaceholderText('Testplaceholder').getAttribute('disabled')).toBeNull();
    ...
    it('implements the min-max-logic', async () => {
        ...
        expect(getByPlaceholderText('Testplaceholder').value).toBe('1');
        await component.$set({ value: -11 });
        expect(getByPlaceholderText('Testplaceholder').value).toBe('-10');
        await component.$set({ value: 11 });
        expect(getByPlaceholderText('Testplaceholder').value).toBe('10');
